...
public class KafkaProducerConfig {
    ...
    public ProducerFactory<String, UserDTO> producerFactory() {
        ...
        JsonSerializer<UserDTO> valueJsonSerializer = new JsonSerializer<>();
...
//                JsonSerializer.class);
        return new DefaultKafkaProducerFactory<>(configProps, new StringSerializer(), valueJsonSerializer);
    }
